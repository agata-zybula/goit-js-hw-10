...
let filteredArray = data => {
  if (data.length > 10) {
    ...
    countryInfo.insertAdjacentHTML(
      ...
      'beforeend',
      `<ul class="list-style"><li class="list-item country-style">${data[0].name.official
      }</li><li class="list-item"><img src="${data[0].flags.svg
      }" alt="Flag" width="150"/></li><li class="list-item">Capital: ${data[0].capital
      }</li><li class="list-item">Population: ${data[0].population
